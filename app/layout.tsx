...
export const metadata: Metadata = {
  ...
  description:
    'AI-powered developer toolbox by reiz_riz — code review, chat with web search, error decoding, commit generation, regex wizard, and doc generation.',
};
        ...
        <div className="min-h-screen flex flex-col bg-[var(--bg-primary)]">
          ...
          <footer className="border-t border-[var(--border)] py-4">
            <div className="max-w-[1600px] mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-[var(--text-muted)]">
              <span>Dev - Tools Box v2.0 — AI Developer Tools</span>
              <a
