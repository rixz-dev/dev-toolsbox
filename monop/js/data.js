...
const GROUPS = { 1:2, 2:3, 3:3, 4:3, 5:3, 6:3, 7:3, 8:2 };
...
const CHANCE_CARDS = [
  ...
  { t:'repair', text:"Make general repairs on all your property — $25 per house, $100 per hotel", house:25, hotel:100 },
...
const COMMUNITY_CHEST_CARDS = [
  ...
  { t:'money', text:"Get Out of Jail Free", getOut:true },
  { t:'move', text:"Go to Jail", to:10, jail:true },
...
let chanceDeck = shuffle([...CHANCE_CARDS]);
let communityDeck = shuffle([...COMMUNITY_CHEST_CARDS]);
